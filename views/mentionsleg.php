<body>
    ...
    <h2>4) Les données personelles</h2>
    ...
    <h2>6) Droit applicable</h2>
        <p>Le présent site et ses mentions légales sont soumis au droit français. En cas de litige, et après une tentative de recherche de solution amiable, compétence expresse est attribuée aux tribunaux français.</p>


    <h2>7) Confidentialité/Résponsabilité</h2>

        <p>Responsabilité des éditrices : Alyssia Frey et Asya Elik s'efforcent d'assurer l'exactitude des informations diffusées sur ce site. Toutefois, elles ne peuvent être tenues responsables des omissions, des inexactitudes ou des carences dans la mise à jour des informations.</p>

            <p>Contenus tiers : Le site peut contenir des liens hypertextes vers d'autres sites. Les éditrices n'exercent aucun contrôle sur le contenu de ces sites tiers et déclinent toute responsabilité quant à leur contenu ou à l'utilisation qui pourrait en être faite.</p>

        <p>Sécurité : Les éditrices mettent en œuvre les mesures nécessaires pour sécuriser les données (notamment via le hachage des mots de passe administrateurs), mais ne sauraient être tenues pour responsables en cas d'intrusion malveillante malgré les précautions prises.</p>

    <h2>8) Contact</h2>

        <p>Pour toute question, signalement de contenu inapproprié ou exercice de vos droits (accès, suppression de données), vous pouvez contacter les éditrices à l'adresse suivante :

           <p>Email : starcine@gmail.com</p>

           <p>Objet : Contact - Starciné</p>
    </div>
